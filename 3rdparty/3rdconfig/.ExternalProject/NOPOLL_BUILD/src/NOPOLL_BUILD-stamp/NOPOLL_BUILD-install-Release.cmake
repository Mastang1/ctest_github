...
set(stderr_log "/home/tang/myproject/tang_test/cTest/3rdparty/3rdconfig/.ExternalProject/NOPOLL_BUILD/src/NOPOLL_BUILD-stamp/NOPOLL_BUILD-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/tang/myproject/tang_test/cTest/3rdparty/3rdconfig/.ExternalProject/NOPOLL_BUILD/src/NOPOLL_BUILD-stamp/NOPOLL_BUILD-install-*.log")
  endif()
  ...
  set(msg "NOPOLL_BUILD install command succeeded.  See also /home/tang/myproject/tang_test/cTest/3rdparty/3rdconfig/.ExternalProject/NOPOLL_BUILD/src/NOPOLL_BUILD-stamp/NOPOLL_BUILD-install-*.log")
  message(STATUS "${msg}")
endif()
