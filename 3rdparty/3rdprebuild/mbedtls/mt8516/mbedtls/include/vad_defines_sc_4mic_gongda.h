...
*/
//#error if you want to build universal sdk, comment this, sound_connect environment needs to changes this file
...
#define MIN_ENERGY          28000//20000//10
...
#define INDIVIDUAL_10MS_AGG 92//82
#define INDIVIDUAL_20MS_AGG 78
#define INDIVIDUAL_30MS_AGG 82

#define TOTAL_10MS_AGG      585//585//385
#define TOTAL_20MS_AGG      260
#define TOTAL_30MS_AGG      285

#define OHMAX1_10MS_AGG     64//45//12//6  // Max Overhang 1
#define OHMAX2_10MS_AGG     70//50//18//9  // Max Overhang 2
