...
int  WVReadHead(FILE *fp, int *channel, int *samplerate, long *dataSize);
void WVWritehead (FILE *fp,UT_uint2_t nChannels,UT_uint4_t nSamplesPerSec, long int Ldata, UT_uint4_t nBitsPerSample);
//extern DAS_FILE_FORMAT GetFileFormat(char* filename);
